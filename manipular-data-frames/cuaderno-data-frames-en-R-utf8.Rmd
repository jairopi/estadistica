...
```{r completar_aquí_11}
concentracion2 <- c(0.51 ,0.51 ,0.5 ,0.49 ,0.5 ,0.56 ,0.48 ,0.49 ,0.45 ,0.48 ,0.49
,0.53 ,0.48 ,0.48 ,0.49 ,0.49 ,0.51 ,0.47 ,0.44 ,0.49)
...
Estos cuatros conjuntos, muy diferentes en su apariencia tienen la misma recta de regresión...
...
```{r completar_aquí_17}
#newcomb <- read.table(file="data/newcomb.txt")
